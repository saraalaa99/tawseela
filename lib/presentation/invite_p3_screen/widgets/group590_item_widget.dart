...
class Group590ItemWidget extends StatelessWidget {
  Group590ItemWidget(this.group590ItemModelObj);

  Group590ItemModel group590ItemModelObj;

  var controller = Get.find<InviteP3Controller>();
