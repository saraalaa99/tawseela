import '../invite_p3_screen/widgets/group590_item_widget.dart';
import '../invite_p3_screen/widgets/group591_item_widget.dart';
import 'controller/invite_p3_controller.dart';
import 'models/group590_item_model.dart';
import 'models/group591_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:sara_s_application1/core/app_export.dart';

class InviteP3Screen extends GetWidget<InviteP3Controller> {
  @override
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              prefixIcon: Padding(
                                                  ...
                                                  child: Container(height: getSize(15.56), width: getSize(15.56), child: SvgPicture.asset(ImageConstant.imgMagnifyingglass113, fit: BoxFit.contain))),
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group590ItemModel
                                                                        ...
                                                                        controller
                                                                            .inviteP3ModelObj
                                                                            .value
                                                                            .group590ItemList[index];
                                                                    return Group590ItemWidget(
                                                                        model);
                                                                  }))),
                                                      Padding(
                                                          padding: EdgeInsets.only(
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group591ItemModel
                                                                        ...
                                                                        controller
                                                                            .inviteP3ModelObj
                                                                            .value
                                                                            .group591ItemList[index];
                                                                    return Group591ItemWidget(
                                                                        model);
                                                                  })))
                                                    ])))
                                      ]))
