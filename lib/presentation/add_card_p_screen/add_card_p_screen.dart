...
class AddCardPScreen extends GetWidget<AddCardPController> {
  @override
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                    Container(
                                                                                        ...
                                                                                        child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                          ...
                                                                                          Padding(padding: EdgeInsets.only(left: getHorizontalSize(4.91), top: getVerticalSize(12.50), right: getHorizontalSize(15.38), bottom: getVerticalSize(13.45)), child: Container(height: getSize(14.42), width: getSize(14.42), child: SvgPicture.asset(ImageConstant.imgGroup1023, fit: BoxFit.fill)))
                                                                                        ])),
                                                                                    Container(
                                                                                        decoration: BoxDecoration(color: ColorConstant.gray50, borderRadius: BorderRadius.circular(getHorizontalSize(2.00)), border: Border.all(color: ColorConstant.indigo100, width: getHorizontalSize(1.00))),
                                                                                        child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                          ...
                                                                                          Padding(padding: EdgeInsets.only(left: getHorizontalSize(7.69), top: getVerticalSize(12.50), right: getHorizontalSize(15.38), bottom: getVerticalSize(13.45)), child: Container(height: getSize(14.42), width: getSize(14.42), child: SvgPicture.asset(ImageConstant.imgGroup1023, fit: BoxFit.fill)))
                                                                                        ]))
                                                                                  ]))
                                                                            ])),
                                                                    Column(
