...
class Group538ItemWidget extends StatelessWidget {
  Group538ItemWidget(this.group538ItemModelObj);

  Group538ItemModel group538ItemModelObj;

  var controller = Get.find<InviteP1Controller>();
