import '../invite_p4_screen/widgets/group616_item_widget.dart';
import '../invite_p4_screen/widgets/group617_item_widget.dart';
import 'controller/invite_p4_controller.dart';
import 'models/group616_item_model.dart';
import 'models/group617_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:sara_s_application1/core/app_export.dart';

class InviteP4Screen extends GetWidget<InviteP4Controller> {
  @override
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              prefixIcon: Padding(
                                                  ...
                                                  child: Container(height: getSize(15.56), width: getSize(15.56), child: SvgPicture.asset(ImageConstant.imgMagnifyingglass114, fit: BoxFit.contain))),
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group616ItemModel
                                                                        ...
                                                                        controller
                                                                            .inviteP4ModelObj
                                                                            .value
                                                                            .group616ItemList[index];
                                                                    return Group616ItemWidget(
                                                                        model);
                                                                  }))),
                                                      Padding(
                                                          padding: EdgeInsets.only(
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group617ItemModel
                                                                        ...
                                                                        controller
                                                                            .inviteP4ModelObj
                                                                            .value
                                                                            .group617ItemList[index];
                                                                    return Group617ItemWidget(
                                                                        model);
                                                                  })))
                                                    ])))
                                      ]))
