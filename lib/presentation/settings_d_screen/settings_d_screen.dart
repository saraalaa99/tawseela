...
class SettingsDScreen extends GetWidget<SettingsDController> {
  @override
                                                                    ...
                                                                    child: Row(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                              ...
                                                                              child: Container(height: getSize(14.39), width: getSize(14.39), child: SvgPicture.asset(ImageConstant.imgGroup1022, fit: BoxFit.fill)))
                                                                        ]))
                                                              ])),
                                                      Padding(
                                                          padding: EdgeInsets.only(
