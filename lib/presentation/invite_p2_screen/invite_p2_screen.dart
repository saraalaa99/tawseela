import '../invite_p2_screen/widgets/group564_item_widget.dart';
import '../invite_p2_screen/widgets/group565_item_widget.dart';
import 'controller/invite_p2_controller.dart';
import 'models/group564_item_model.dart';
import 'models/group565_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:sara_s_application1/core/app_export.dart';

class InviteP2Screen extends GetWidget<InviteP2Controller> {
  @override
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              prefixIcon: Padding(
                                                  ...
                                                  child: Container(height: getSize(15.56), width: getSize(15.56), child: SvgPicture.asset(ImageConstant.imgMagnifyingglass112, fit: BoxFit.contain))),
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group564ItemModel
                                                                        ...
                                                                        controller
                                                                            .inviteP2ModelObj
                                                                            .value
                                                                            .group564ItemList[index];
                                                                    return Group564ItemWidget(
                                                                        model);
                                                                  }))),
                                                      Padding(
                                                          padding: EdgeInsets.only(
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group565ItemModel
                                                                        ...
                                                                        controller
                                                                            .inviteP2ModelObj
                                                                            .value
                                                                            .group565ItemList[index];
                                                                    return Group565ItemWidget(
                                                                        model);
                                                                  })))
                                                    ])))
                                      ]))
