...
class Group565ItemWidget extends StatelessWidget {
  Group565ItemWidget(this.group565ItemModelObj);

  Group565ItemModel group565ItemModelObj;

  var controller = Get.find<InviteP2Controller>();
