...
class HistoryPItemWidget extends StatelessWidget {
  HistoryPItemWidget(this.historyPItemModelObj);

  HistoryPItemModel historyPItemModelObj;

  var controller = Get.find<HistoryPController>();
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: SvgPicture.asset(
                                ImageConstant.imgNavigation111,
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
