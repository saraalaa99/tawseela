import '../history_p_screen/widgets/history_p_item_widget.dart';
import 'controller/history_p_controller.dart';
import 'models/history_p_item_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:sara_s_application1/core/app_export.dart';

class HistoryPScreen extends GetWidget<HistoryPController> {
  @override
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Obx(() => ListView.builder(
                                                                            ...
                                                                            shrinkWrap: true,
                                                                            itemCount: controller.historyPModelObj.value.historyPItemList.length,
                                                                            itemBuilder: (context, index) {
                                                                              HistoryPItemModel model = controller.historyPModelObj.value.historyPItemList[index];
                                                                              return HistoryPItemWidget(model);
                                                                            })))),
                                                                Padding(
                                                                    padding: EdgeInsets.only(
                                                                        left: getHorizontalSize(
                                                                        ...
                                                                        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                              ...
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                Padding(
                                                                                    ...
                                                                                    child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                      Padding(padding: EdgeInsets.only(bottom: getVerticalSize(3.11)), child: Container(height: getVerticalSize(20.44), width: getHorizontalSize(16.23), child: SvgPicture.asset(ImageConstant.imgGroup269, fit: BoxFit.fill))),
                                                                          ...
                                                                          Padding(
                                                                              ...
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(263.64), bottom: getVerticalSize(5.00)), child: Container(height: getSize(15.34), width: getSize(15.34), child: SvgPicture.asset(ImageConstant.imgStar111, fit: BoxFit.fill))),
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                    Padding(
                                                                                        ...
                                                                                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                                                                                          Padding(padding: EdgeInsets.only(top: getVerticalSize(1.96), bottom: getVerticalSize(4.70)), child: Container(height: getSize(15.34), width: getSize(15.34), child: SvgPicture.asset(ImageConstant.imgNavigation114, fit: BoxFit.fill))),
                                                                    ...
                                                                    child: Row(
                                                                        ...
                                                                        children: [
                                                                          Padding(
                                                                              ...
                                                                              child: Container(height: getSize(15.34), width: getSize(15.34), child: SvgPicture.asset(ImageConstant.imgStar112, fit: BoxFit.fill))),
                                                                          Padding(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                          Padding(
                                                                              ...
                                                                              child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                                                                                Padding(padding: EdgeInsets.only(top: getVerticalSize(1.96), bottom: getVerticalSize(4.70)), child: Container(height: getSize(15.34), width: getSize(15.34), child: SvgPicture.asset(ImageConstant.imgNavigation115, fit: BoxFit.fill))),
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(9.58)), child: Text("lbl_chalotte_st".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textStyleAxiformaregular141.copyWith(fontSize: getFontSize(14))))
                                                                              ])),
                                                                          Padding(
