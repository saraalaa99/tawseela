...
class Book4Screen extends GetWidget<Book4Controller> {
  @override
                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(right: getHorizontalSize(10.00)), child: Container(height: getSize(32.00), width: getSize(32.00), child: SvgPicture.asset(ImageConstant.imgYourlocation9, fit: BoxFit.fill)))),
                                                                                    Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), top: getVerticalSize(114.00)), child: Container(height: getSize(30.72), width: getSize(30.72), child: SvgPicture.asset(ImageConstant.imgYourlocation10, fit: BoxFit.fill))))
                                                                                  ])))
                                                                        ]))),
                                                                Align(
                                                                    alignment:
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                          Row(
                                                                              ...
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: [
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(54.80), top: getVerticalSize(1.45), bottom: getVerticalSize(0.36)), child: Container(height: getVerticalSize(20.47), width: getHorizontalSize(16.25), child: SvgPicture.asset(ImageConstant.imgGroup266, fit: BoxFit.fill))),
                                                                                ...
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.24), top: getVerticalSize(4.24), bottom: getVerticalSize(2.68)), child: Container(height: getSize(15.36), width: getSize(15.36), child: SvgPicture.asset(ImageConstant.imgNavigation19, fit: BoxFit.fill))),
                                                                              ...
                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                ...
                                                                                Container(
                                                                                    ...
                                                                                    child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                      Padding(padding: EdgeInsets.only(left: getHorizontalSize(13.36), top: getVerticalSize(9.56), bottom: getVerticalSize(9.64)), child: Container(height: getSize(15.36), width: getSize(15.36), child: SvgPicture.asset(ImageConstant.imgStar16, fit: BoxFit.fill))),
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                    ...
                                                                                    Padding(
                                                                                        ...
                                                                                        child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                          ...
                                                                                          Padding(padding: EdgeInsets.only(left: getHorizontalSize(9.60)), child: Container(alignment: Alignment.center, height: getSize(34.56), width: getSize(34.56), decoration: AppDecoration.textStyleAxiformamedium173, child: Text("lbl_4".tr, textAlign: TextAlign.center, style: AppStyle.textStyleAxiformamedium173.copyWith(fontSize: getFontSize(17)))))
                                                                                        ]))
                                                                                  ]))),
                                                                          Align(
                                                                              alignment: Alignment.center,
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, mainAxisSize: MainAxisSize.max, children: [
                                                                                    ...
                                                                                    Padding(
                                                                                        ...
                                                                                        child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                                                          ...
                                                                                          Padding(padding: EdgeInsets.only(left: getHorizontalSize(9.60)), child: Container(height: getSize(34.56), width: getSize(34.56), child: SvgPicture.asset(ImageConstant.imgGroup472, fit: BoxFit.fill)))
                                                                                        ]))
                                                                                  ]))),
                                                                          Align(
                                                                              alignment: Alignment.center,
