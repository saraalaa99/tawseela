import '../pay_screen/widgets/pay_item_widget.dart';
                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(right: getHorizontalSize(10.00)), child: Container(height: getSize(32.00), width: getSize(32.00), child: SvgPicture.asset(ImageConstant.imgYourlocation13, fit: BoxFit.fill)))),
                                                                                    Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), top: getVerticalSize(114.00)), child: Container(height: getSize(30.72), width: getSize(30.72), child: SvgPicture.asset(ImageConstant.imgYourlocation14, fit: BoxFit.fill))))
                                                                                  ])))
                                                                        ]))),
                                                                Align(
                                                                    alignment:
                                                                        ...
                                                                        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                          ...
                                                                          Padding(
                                                                              ...
                                                                              child: Obx(() => ListView.builder(
                                                                                  ...
                                                                                  shrinkWrap: true,
                                                                                  itemCount: controller.payModelObj.value.payItemList.length,
                                                                                  itemBuilder: (context, index) {
                                                                                    PayItemModel model = controller.payModelObj.value.payItemList[index];
                                                                                    return PayItemWidget(model);
                                                                                  }))),
                                                                          Padding(
                                                                              ...
                                                                              child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                Align(
                                                                                    ...
                                                                                    child: Container(
                                                                                        ...
                                                                                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                          Padding(padding: EdgeInsets.only(bottom: getVerticalSize(21.08)), child: Image.asset(ImageConstant.imgImage54, height: getVerticalSize(31.54), width: getHorizontalSize(30.01), fit: BoxFit.fill)),
