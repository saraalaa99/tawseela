import '../notf_d_screen/widgets/group484_item_widget.dart';
import '../notf_d_screen/widgets/group485_item_widget.dart';
...
class NotfDScreen extends GetWidget<NotfDController> {
  @override
                                          ...
                                          child: Obx(
                                            () => ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                Group484ItemModel model =
                                                    controller
                                                            .notfDModelObj
                                                            .value
                                                            .group484ItemList[
                                                        index];
                                                return Group484ItemWidget(
                                                  model,
                                                );
                                              },
                                            ),
                                          ...
                                          child: Obx(
                                            () => ListView.builder(
                                              ...
                                              itemCount: controller
                                                  ...
                                                  .length,
                                              itemBuilder: (context, index) {
                                                Group485ItemModel model =
                                                    controller
                                                            .notfDModelObj
                                                            .value
                                                            .group485ItemList[
                                                        index];
                                                return Group485ItemWidget(
                                                  model,
                                                );
                                              },
                                            ),
