import '../invite_p_screen/widgets/group512_item_widget.dart';
import '../invite_p_screen/widgets/group513_item_widget.dart';
...
class InvitePScreen extends GetWidget<InvitePController> {
  @override
                                      ...
                                      child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              prefixIcon: Padding(
                                                  ...
                                                  child: Container(height: getSize(15.56), width: getSize(15.56), child: SvgPicture.asset(ImageConstant.imgMagnifyingglass11, fit: BoxFit.contain))),
                                                                ...
                                                                Padding(
                                                                    padding: EdgeInsets.only(
                                                                        ...
                                                                        top: getVerticalSize(
                                                                            10.70),
                                                                        bottom:
                                                                            getVerticalSize(10.70)),
                                                                    child: GestureDetector(
                                                                        onTap: () {
                                                                          onTapBtnInvite();
                                                                        },
                                                                        child: Container(alignment: Alignment.center, height: getVerticalSize(35.02), width: getHorizontalSize(83.66), decoration: AppDecoration.textStyleAxiformamedium177, child: Text("lbl_invite".tr, textAlign: TextAlign.center, style: AppStyle.textStyleAxiformamedium177.copyWith(fontSize: getFontSize(17))))))
                                                              ])),
                                                      Padding(
                                                          padding: EdgeInsets.only(
                                                              top:
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group512ItemModel
                                                                        ...
                                                                        controller
                                                                            .invitePModelObj
                                                                            .value
                                                                            .group512ItemList[index];
                                                                    return Group512ItemWidget(
                                                                        model);
                                                                  }))),
                                                      Padding(
                                                          padding: EdgeInsets.only(
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    Group513ItemModel
                                                                        ...
                                                                        controller
                                                                            .invitePModelObj
                                                                            .value
                                                                            .group513ItemList[index];
                                                                    return Group513ItemWidget(
                                                                        model,
                                                                        onTapBtnInvite:
                                                                            onTapBtnInvite);
                                                                  })))
