...
class MenuDriverScreen extends GetWidget<MenuDriverController> {
  @override
                                                    ...
                                                    padding: EdgeInsets.only(
                                                        ...
                                                        right:
                                                            getHorizontalSize(
                                                                18.00)),
                                                    child: Text(
                                                        "msg_toyota_edf568".tr,
                                                        overflow: TextOverflow
                                                            .ellipsis,
                                                        textAlign:
                                                            TextAlign.center,
                                                        style: AppStyle
                                                            .textStyleAxiformamedium144
                                                            .copyWith(
                                                                fontSize:
                                                                    getFontSize(
                                                                        14))))),
                                            ...
                                            Align(
                                                ...
                                                child: GestureDetector(
                                                    ...
                                                    child: Container(
                                                        ...
                                                        child: Text("msg_switch_to_passe".tr,
                                                            maxLines: null,
                                                            textAlign:
                                                                TextAlign.left,
